...
class UserRegistration(Resource):
    def post(self):
        ...
        if UserModel.find_by_username(data['username']):
            return {'message':'User {} already exist'.format(data['username'])}
...
class UserLogin(Resource):
    def post(self):
        ...
        if not current_user:
            return {'message':'User {} dosent exist'.format(data['username'])}
...
class UserLogoutAccess(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            revoked_token.add()
            return {'message':'Access token has been revooked'}
        except:
